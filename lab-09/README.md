# Lab 9: Code Security for Applications (SCA)

## Objectives

Lab 8 scanned the code that builds your infrastructure. This lab scans the application that
...
![CloudShell with lacework version output](../lab-12/images/aws-cloudshell-lacework-version.png)
...
>
> As in Lab 8, results still will not appear under **Risk Center** > **Findings** >
...
Work through the same three questions as Lab 8:
...
Next: [Lab 10: Clean Up Workshop Resources](../lab-10/README.md).
